...
import { TEXT } from "../editors/roomTypes/roomTypes.text";
import {
  asArray,
  asPosInt,
  asString,
  ...
  normalizeRoom,
  sanitizeNumberStr,
} from "../editors/roomTypes/roomTypes.utils";

import RoomImagesEditor from "../editors/roomTypes/RoomImagesEditor";
import BedsEditor from "../editors/roomTypes/BedsEditor";
import RatePlansEditor from "../editors/roomTypes/RatePlansEditor";
...
export default function RoomTypesEditor({ roomAmenities = [], value = [], onChange }) {
  ...
  const onChangeCode = (idx, nextCode) => {
    setRoom(idx, { code: asString(nextCode, ""), codeManual: true });
  };
