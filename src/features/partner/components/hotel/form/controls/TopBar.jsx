...
export default function TopBar({ loading, onBack, onReset, onSubmit, canSubmit }) {
  return (
    <div className="bg-white rounded-2xl border p-4 flex flex-wrap items-center justify-between gap-3">
      <div>
        <div className="text-xl font-bold">Thêm khách sạn</div>
        <div className="text-xs text-gray-500">Sau khi tạo sẽ về PENDING chờ admin duyệt.</div>
      </div>
