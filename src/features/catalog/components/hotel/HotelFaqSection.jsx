    ...
    <>
        ...
        <div className="grid gap-0 md:grid-cols-[270px,1fr]">
          ...
          <div className="flex flex-col gap-4 bg-gradient-to-b from-[#dbeeff] to-[#f4f9ff] dark:from-slate-900 dark:to-slate-800 px-6 py-6 md:py-8">
            ...
            <div className="hidden md:flex flex-col items-center gap-2">
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-white/80 dark:bg-slate-800/90 shadow-sm">
                ...
                return (
                  <div key={question || idx} className="bg-white dark:bg-gray-800">
                    <button
                      ...
                      className="flex w-full items-center justify-between px-4 py-3 text-left hover:bg-[#f5f7fb] dark:hover:bg-slate-700/60"
                    >
                    ...
                    {isOpen && answer && (
                      <div className="bg-[#f9fafb] dark:bg-slate-900/60">
                        <div className="mx-4 mb-3 rounded-xl border border-[#e0e7ff] dark:border-slate-700 bg-white dark:bg-slate-900 px-3.5 py-3 text-sm leading-relaxed text-gray-700 dark:text-gray-300 shadow-sm">
                          <div className="mb-1 flex items-center gap-2">
                            <div className="flex h-6 w-6 items-center justify-center rounded-full bg-[#e2ebff] dark:bg-sky-950/50 text-[#0064d2] dark:text-sky-300">
                              <MessageCircle className="h-3.5 w-3.5" />
                            </div>
                            <span className="text-[11px] font-semibold uppercase tracking-wide text-[#1d4ed8] dark:text-sky-300">
                              {t("hotel.faq_answer")}
                            </span>
                          </div>
      ...
      {isDrawerOpen && (
        <div className="fixed inset-0 z-[200] flex justify-end">
          ...
          {/* PANEL PHẢI */}
          <div className="relative flex h-screen w-full max-w-xl flex-col bg-white dark:bg-slate-800 shadow-xl">
            {/* HERO */}
            ...
            <div className="flex-1 overflow-y-auto bg-[#f5f7fb] dark:bg-slate-900 px-0 py-3">
              <div className="divide-y divide-gray-100 dark:divide-gray-700 bg-white dark:bg-slate-800">
                {faqs.map((faq, idx) => {
