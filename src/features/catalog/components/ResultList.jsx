      ...
      {items.map((p) => (
        ...
        >
          <div className="flex flex-col md:flex-row">
            <div className="md:w-[280px] md:h-[180px] w-full h-48 shrink-0 overflow-hidden rounded-t-xl md:rounded-l-xl md:rounded-tr-none relative">
              {p.coverImageUrl
            ...
            <div className="flex-1 p-4">
              <div className="min-w-0">
                ...
                <div className="text-sm text-gray-500 dark:text-gray-400 mt-1 line-clamp-2">{p.shortDescription || p.addressLine}</div>
